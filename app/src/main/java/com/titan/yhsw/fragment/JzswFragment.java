...
public class JzswFragment extends Fragment {
    ...
    //private Map<String,String> whbw=new HashMap<>();
    ...
    private void queryPest(final String keyword) {
        ...
        Injection.provideDataRepository(getActivity()).queryPest(3, keyword,whbwset, new LDataSource.qureyCalllback() {
            @Override
            public void onFailure(String info) {
                Toast.makeText(mContext, "寄主查询失败" + info, Toast.LENGTH_LONG).show();
            }
