...
/**
 * Created by whs on 2017/11/13
 */

public class HostAdapter<T> extends BaseAdapter implements Filterable {
    ...
    public HostAdapter(Context con, List<T> data) {
    ...
    public View getView(int peisition, View conview, ViewGroup arg2) {
        ...
        if (conview == null) {
            ...
            view = con.inflate(R.layout.item_host, null);
            vh.te = (TextView) view.findViewById(R.id.tv_host);
            view.setTag(vh);
